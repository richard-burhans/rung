...
# (dispensary_scraper_intel.proxy_store). See docs/distributed_scraping_design.md §2.1/§3.
_CREATE_PROXIES = """
...
# selection POLICY (config default + this override) is private (dispensary_scraper_intel.proxy_tiers).
...
def _migrate_store_products(conn: DBConn) -> None:
    """Add any store_products columns missing from an older database."""
